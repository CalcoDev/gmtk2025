...
const SHARD = preload("uid://5klnak31y0wi")
...
func shatter() -> void:
    ...
    for s in shards:
        ...
        s.apply_central_impulse(Vector2.UP * randf_range(700, 1500))
        # s.apply_central_impulse(Vector2.UP * 10000)
